...
* Please choose a shorter name for the service binding. The default name will be over 32 charcters and may cause an error.
* Click the blue _Create_ button to accept the new service binding name.

----
NOTE: Please do not accept the default service binding name as the name of the service bind should be less that 32 Characters 
----
